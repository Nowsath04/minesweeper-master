...
export default class Scoreboard {
  constructor(game, gameData) {
    ...
    let timeLabel = this.game.add.text(40 * DPR, rowsHeight * 2.5, 'Game Time', fontStyle);
    let timeText = this.game.add.text(w - 40 * DPR, rowsHeight * 2.5, this.gameData.currentTime, fontStyle);
    let bestLabel = this.game.add.text(40 * DPR, rowsHeight * 3.5, 'Best Record', fontStyle);
